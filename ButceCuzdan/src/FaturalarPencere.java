...
public class FaturalarPencere extends javax.swing.JFrame {
    ...
    private void btnGosterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGosterActionPerformed
        //Göster butonuna tıklandığında faturalar sınıfından nesne üretiyoruz
        faturalar = new Faturalar();
        //İlgili labellara bilgileri yazdırdığımız metodu çağırıyoruz
        yazdir();
    }//GEN-LAST:event_btnGosterActionPerformed

    public void yazdir(){
        //JComboBoxta seçilen ayı ay Stringine atıyoruz
        String ay = String.valueOf(cbAylar.getSelectedItem());
        
        //Döngü ile seçilen ay ile faturalar sınıfındaki ay dizisindeki elemanları karşılaştırıyoruz
        for (int i = 0; i < faturalar.ay.length; i++) {
            if(faturalar.ay[i].equals(ay)){
                //if bloğuna girdiğinde ilgili aydaki bilgileri labellara yazdırıyoruz
